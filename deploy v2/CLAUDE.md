...
> - **Live:** Heroku **v162** · engine `thammen-sprint2p22p0a23-stratum-land-a18` (a23 = R15 strata-land a18; a22 = B-1.1 framing; a21 = B-1 land-floor/HBU) · capture **DORMANT** · `master == origin` (sprint tip `ff483b0` + this docs-close; read live via #57).
