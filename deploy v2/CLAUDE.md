...
> - **Live:** Heroku **v166** · engine `thammen-sprint2p22p0b2-staged-input-flow` (b2 = guided staged-input WRAP [Stage-2 geometry confirm + `effective_footprint_m2`, value-invariant]; b1 = zoning-driven ground-footprint suggestion + **basement excluded from the comparison driver** [geometry §5.2/§5.5, **value-invariant on no-building-input anchors**]; a25 = CC BY 4.0 MoJ source-attribution footer credit; a24 = beta consent **entry gate** + Terms/Privacy + DPIA; a23 = R15 strata-land a18) · capture **DORMANT** · `master == origin` (b2 SHIPPED — Heroku **v166**, deploy split `a13cfc8` of `39fb949`; read live via #57).
