...
> - **Live:** Heroku **v161** · engine `thammen-sprint2p22p0a22-b1p1-framing-copy` (a22 = B-1.1 framing tweaks; a21 = B-1 land-floor/HBU) · capture **DORMANT** · `master == origin` (sprint tip `2d401b5` + this docs-close; read live via #57).
