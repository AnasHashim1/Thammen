...
> - **Live:** Heroku **v163** · engine `thammen-sprint2p22p0a24-beta-entry-gate` (a24 = beta onboarding/consent **entry gate** + Terms/Privacy + DPIA; a23 = R15 strata-land a18; a22 = B-1.1 framing) · capture **DORMANT** · `master == origin` (sprint tip `d538e93` + this docs-close; read live via #57).
