...
> - **Live:** Heroku **v164** · engine `thammen-sprint2p22p0a25-moj-source-attribution-ccby` (a25 = CC BY 4.0 MoJ source-attribution footer credit [Q13/R13 closure], value-invariant; a24 = beta consent **entry gate** + Terms/Privacy + DPIA; a23 = R15 strata-land a18) · capture **DORMANT** · `master == origin` (sprint tip `d9d148a` + this docs-close; read live via #57).
