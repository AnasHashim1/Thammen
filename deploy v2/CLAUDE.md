...
> - **⏸ GATE-1 PENDING (2026-06-11): Sprint 2.22.0b.20 «EVIDENCE-CONDITIONAL LEADERSHIP» BUILT + FULLY VERIFIED, NOT DEPLOYED — live stays b18/v187.** 🔴 Gate-2 SIGNED (Anas F6, `docs/SESSION_CLOSE_2026-06-11_F6_SIGNED.md`; normative spec `docs/BRIEF_conditional_leadership_SIGNED.md`; numbers `docs/PHASE0_conditional_leadership.md` §2.7 — **7/13 = 54% cost-led**). The single leadership gate replaces the b6/b11/b16 elif chain (income_led precedence + b13/b18 sensitivity + b4 levers unchanged; pure calculators kept): RULE 1 matched n≥10/disp36<0.30/match → market · RULE 2 geo-full n≥20/disp<0.30 → market + «حوض جغرافي غير مطابق طبقياً» + MUC+1 + cost floor · else COST leads F3(b) [cost…market-muted] · E25 rail (cost never leads upward; المعراض capped + divergence) · F2=B re-survey untestable. Three-value stack + dispersion EMITTED (G1/G2). Verified: isolated 69/69 · siblings green (b16/b18 re-pointed 4 superseded pins) · DoD 392/15/45/broad ALL GREEN · local E2E 22-cohort == the signed §2.7 table (امريخ cost-led 2.4M [2.4…5.4] · V001 3.8M floor 3.1M geo-rescue · V002/V003 rescued+re-survey note · المعراض E25-capped 2.6M) · R14 0-errors no-overflow. CHANGELOG_v102. **النشر يحتاج موافقة أناس Gate-1 الصريحة المنفصلة؛ بعده: two-lane smoke + إعادة الالتقاط (fixtures هندسية، Phase-0 §4.2).**
