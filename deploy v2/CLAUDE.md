...
> - **Live:** Heroku **v157** · engine `thammen-sprint2p22p0a18-area-name-reconciliation` (a18) · capture **DORMANT** · `master == origin` (tip `d69d9c0`; read live via #57).
...
> - **Engineering = ACTIVE on signed briefs (#32)** — last shipped **a18** (R9 bracket-path area-name reconciliation — VALUATION-AFFECTING; the brief's highest-count-wins→bare-parent was REJECTED at the الثمامة 46 hard gate [MoJ files recent txns under sub-zone labels, stale under bare parent → −7.5%/−20%/−40% silent regressions] → adopted **sibling aggregation** [«افعل الأصوب»]; Heroku v157, CHANGELOG_v70, §20.18; isolated 28/28 + DoD 392/15/45/61; anchors: 56/565/21 = 2.4M UNCHANGED, Marikh 54/541/6 = 4.5M widened → 5.4M thin same-district مريخ). Monetization still gated on the regulatory enquiry + open-data licence.
