...
### 🆕 Rule E25 — Cost (DRC) is a FLOOR, never a market proxy — and it never chases ASK prices (REWRITTEN by the 2026-06-10 errata)

✗→✓ **REWRITTEN 2026-06-10 (errata — PO disclosure):** the original E25 («a new-premium villa's market premium EXCEEDS its replacement cost», measured on V002/V003 «SOLD 4.0M each») rested on entries now disclosed as **OWNER ASPIRATION, not transactions** (reclassified **T2-aspiration** in `VALIDATION_LOG.md`; no document exists). **E1/E3 reaffirmed: asking/aspiration prices are NEVER calibration evidence.**

**The measured facts that remain (V002/V003-class, new-premium 450 m²):** composition estimate = RCN_lux 3,500 × ~470 m² BUA + land 3,778 QAR/m² × 450 m² (n=33) ≈ **3.35M** · engine bracket **2.4/2.5M** · **ASK 4.0M**. The **premium-over-cost is UNMEASURED** — the corpus holds **zero documented confirmed sales of new-premium stock**; the −37/40% «under-anchor» figure was aspiration-based and is **withdrawn as a measurement** (the true under-anchor magnitude is an OPEN question awaiting the first documented sales — the GT kit targets ≥8 luxury_new **with documents**).

**The rule (the structural lesson STANDS — now justified by V001 alone, the one certified sheet).** The cost approach (DRC) is a **FLOOR**, never a market proxy and never a market-premium **ceiling** — and it must **NEVER chase ASK prices**: lifting a central toward an asking/aspiration figure would launder E1's rejected uplift through the cost approach. The §20.47 Lever-2 drop therefore **stands on these grounds** (cost-must-not-chase-ask + premium-over-cost unmeasured), not on a «sale above cost». The durable fix for any REAL new-premium under-anchor remains a **calibrated `luxury_new` comparable stratum** (B-2-proper, corpus-calibrated from **documented** GT — n=0 today, PARKED on n≥20). (Symmetric to E24: the cost is a sound *floor*, immune via the system-age FLOOR.)

**Pairs with:** **E1/E3** (reaffirmed) + **E24**; RISK_REGISTER **R7** (the under-anchor half — now UNMEASURED) + **R19** (GT scarcity); the `VALIDATION_LOG.md` **intake document-rule** (no n without سند/عقد/شيت — retro-applied); §20.47 + §20.52.1 (the errata of record). Recall: **"تذكر E25"** / **"تذكر الكلفة لا تطارد الطلب"**.
