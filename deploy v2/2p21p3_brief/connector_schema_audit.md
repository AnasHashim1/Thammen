...
# Connector Schema Audit — Sprint 2.21.3 (ROUND 2)

**Run timestamp (UTC):** 2026-05-24 17:36:49
**Total wall time:** 19.0s
**Origin:** Heroku
**Goal:** close round-1 FALSE predictions (S2 PF SALES + S3 arady real detail).

---

## V1 — arady sitemap.xml discovery

- Status: HTTP 200
- Total listing-looking URLs: 5
- Apartment+Lusail: 0
- Apartment-any: 1
- Lusail-any: 0
- Winner URL: `https://arady.qa/listings/apartments`
- **V1 verdict (≥5 apartment URLs):** ❌ FALSE

Sample sitemap URLs (first 10):
  - https://arady.qa/listings
  - https://arady.qa/listings/lands
  - https://arady.qa/listings/villas
  - https://arady.qa/listings/apartments
  - https://arady.qa/listings/investments

---

## V2 — PF path-style SALE candidates

| URL | HTTP | sale/rent | big_prices(>500K) | QAR_tokens | max_price |
|---|:---:|---|---:|---:|---:|
| `.../en/buy/doha/apartments-for-sale.html` | 200 | SALE | 26 | 34 | 2,600,000 |
| `.../en/buy/doha/apartments-for-sale-lusail.html` | 404 | N/A | 0 | 0 | 0 |
| `.../en/buy/lusail/apartments-for-sale.html` | 200 | SALE | 16 | 20 | 7,172,485 |
| `.../en/buy/qatar/apartments-for-sale.html` | 404 | N/A | 0 | 0 | 0 |
| `.../en/buy/qatar/apartments-for-sale-lusail.html` | 404 | N/A | 0 | 0 | 0 |
| `.../en/search?c=3&t=1&l=63` | 404 | N/A | 0 | 0 | 0 |

**Winner:** `https://www.propertyfinder.qa/en/buy/doha/apartments-for-sale.html`

**V2 verdict (winner with ≥3 big_prices):** ✅ TRUE

---

## V3 — arady REAL detail extraction

- **URL:** `https://arady.qa/listings/apartments`
- **HTTP:** 200, **length:** 489,593
- **Title:** شقق للبيع في قطر | أراضي قطر
- **Title is SALE:** True, **is RENT:** False
- **Listing price:** None
- **Apartment area:** None m²
- **Bedrooms:** 3
- **Lusail in body:** True
- **QAR-only prices found:** []
- **All prices found:** []
- **All areas found:** []
- **`property-price` class:** True
- **`data-test="price"`:** False
...
## V4 — PF SALE detail extraction

- **URL:** `https://www.propertyfinder.qa/en/plp/buy/apartment-for-sale-doha-the-pearl-island-porto-arabia-east-porto-drive-54006689.html`
- **HTTP:** 200, **length:** 326,047
- **Title:** Sale in East Porto Drive: semi furnished 2bhk sea view porto arabia | Property Finder
- **Title is SALE:** False, **is RENT:** False
- **Listing price:** ('AED', 150000)
- **Apartment area:** 156.0 m²
- **Bedrooms:** 1
- **Lusail in body:** True
- **QAR-only prices found:** []
- **All prices found:** [('AED', 580), ('AED', 2000), ('AED', 4000), ('AED', 6000), ('AED', 8000), ('AED', 2000), ('AED', 130), ('AED', 4000), ('AED', 130), ('AED', 150000)]
- **All areas found:** [156.0, 156.0, 156.0, 156.0, 156.0, 156.0, 156.0, 156.0, 156.0, 156.0]
- **`property-price` class:** True
- **`data-test="price"`:** False
- **Extractable:** True
...
<!DOCTYPE html><html dir="ltr" platform="desktop" lang="en" style="scroll-behavior:smooth"><head><meta charSet="utf-8"/><meta name="viewport" content="width=device-width, initial-scale=1"/><style>
        ...
        </style><meta name="page-name" content="plp"/><script id="plp-schema" type="application/ld+json">{"@context":"https://schema.org/","@id":"http://schema.org/54006689","@type":["webpage","ApartmentComplex","RealEstateListing","House","product"],"speakable":{"@type":"SpeakableSpecification","xpath":["/html/head/meta[@name='description']/@content"]},"breadcrumb":{"@context":"http://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","name":"Property Finder","item":"https://www.propertyfinder.qa/","position":1},{"@type":"ListItem","name":"Apartments for sale in Doha","item":"https://www.propertyfinder.qa/en/buy/doha/apartments-for-sale.html","position":2},{"@type":"ListItem","name":"The Pearl Island","item":"https://www.propertyfinder.qa/en/buy/doha/apartments-for-sale-the-pearl-island.html","position":3},{"@type":"ListItem","name":"Porto Arabia","item":"https://www.propertyfinder.qa/en/buy/doha/apartments-for-sale-the-pearl-island-porto-arabia.html","position":4},{"@type":"ListItem","name":"East Porto Drive","item":"https://www.propertyfinder.qa/en/buy/doha/apartments-for-sale-the-pearl-island-porto-arabia-east-porto-drive.html","position":5},{"@type":"ListItem","name":"semi furnished 2bhk sea view porto arabia","item":"https://www.propertyfinder.qa/en/plp/buy/apartment-for-sale-doha-the-pearl-island-porto-arabia-east-porto-drive-54006689.html","position":6}],"numberOfItems":6},"mainEntity":{"@type":"WebPage","mainEntity":{"@type":["ApartmentComplex","RealEstateListing","House"],"@id":"http://schema.org/
```
...
## Predictions ledger (V1–V4)

- **V1** arady sitemap has real listing URLs: ❌ FALSE
- **V2** PF path-style SALE identified: ✅ TRUE
- **V3** arady REAL detail extractable: ❌ FALSE
- **V4** PF SALE detail extractable: ❌ FALSE

---

*Generated by `2p21p3_pre/probe_schema_v2_2p21p3.py`. Appended to
`2p21p3_brief/connector_schema_audit.md` as round-2 section after capture.*
---
